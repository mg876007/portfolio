  ...
  const contactInfo = [
    {
      icon: EnvelopeIcon,
      title: 'Email',
      value: 'mayank2509gupta@gmail.com',
          ...
          >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                   ...
                   whileTap={{ scale: 0.9 }}
                   className="w-10 h-10 bg-gray-900 text-white rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors duration-300"
                 >
